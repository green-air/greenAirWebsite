...
function About() {
    return (
        <div className='gridContain'>
            ...
            <img src={image} width="700" height="300" style={{ position: 'relative', left: '10px' }} alt="green air logo"></img>
            <img src={require('../images/rebuild the earth pic.png')} width="400" height="300" style={{ position: 'relative', left: '250px' }} alt="someone rebuilding the earth"></img>
            <div style={{ padding: '10px' }}>
            ...
            <img src={require('../images/world car free pic.png')} width="400" height="300" style={{ position: 'relative', left: '300px' }} alt="car free world representation"></img>
